// RINSPACE_SHARED_GENERATED: runtime bindings for the shared topbar.
export { AnimateButton } from './mastodon/components/rinspace_animate/button';
export { Bell as AnimateBell } from './mastodon/components/rinspace_animate/icons/bell';
