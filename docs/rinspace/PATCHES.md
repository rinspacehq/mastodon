...
9. Build immutable images and source artifacts, record their digests with the exact fork commit and private Rinspace integration-contract revision, and rehearse rollback before release approval. Do not include a `rinspace-web` or `@rinspace/world-shell` release in a new lock.
